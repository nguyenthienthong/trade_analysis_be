...
let DailyStat = class DailyStat extends sequelize_typescript_1.Model {
};
...
], DailyStat.prototype, "totalTrades", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.INTEGER),
    __metadata("design:type", Number)
], DailyStat.prototype, "wins", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.INTEGER),
    __metadata("design:type", Number)
], DailyStat.prototype, "losses", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.DECIMAL(18, 8)),
    __metadata("design:type", String)
], DailyStat.prototype, "pnl", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.DECIMAL(18, 8)),
    __metadata("design:type", String)
], DailyStat.prototype, "maxDrawdown", void 0);
exports.DailyStat = DailyStat = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "daily_stats", underscored: true, timestamps: false })
], DailyStat);
